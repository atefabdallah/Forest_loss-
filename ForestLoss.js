...
var tree_cover_2020 = ee.Image("UMD/hansen/global_forest_change_2020_v1_8");
var tree_cover_2023 = ee.Image("UMD/hansen/global_forest_change_2023_v1_11");

// Select the 'loss' bands from both years
var loss_2020 = tree_cover_2020.select(['loss']);
var loss_2023 = tree_cover_2023.select(['loss']);
...
var arealoss = total_loss.multiply(ee.Image.pixelArea());
...
print('Area lost in Germany:', lossStats.get('loss'), 'square meters');
